    ...
    en: (
      <>
        ...
        <p style={styles.textWithMargin}>
          ...
          <strong>{applicationTitle}</strong> has been rejected. Please note
          that it is not possible for us or the sponsor to share individual
          feedback on your grant application.
        </p>
        <p style={styles.textWithMargin}>
    ...
    fr: (
      <>
        ...
        <p style={styles.textWithMargin}>
          ...
          <strong>{applicationTitle}</strong> a été rejetée. Veuillez noter
          qu'il ne nous est pas possible, ni au sponsor, de fournir un retour
          individuel sur cette candidature.
        </p>
        <p style={styles.textWithMargin}>
    ...
    vi: (
      <>
        ...
        <p style={styles.textWithMargin}>
          ...
          <strong>{applicationTitle}</strong> đã bị từ chối. Xin lưu ý rằng cả
          chúng tôi và nhà tài trợ đều không thể cung cấp phản hồi chi tiết cho
          từng đơn.
        </p>
        <p style={styles.textWithMargin}>
